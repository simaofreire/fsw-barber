...
async function seedDatabase() {
  try {
    ...
    //   where: { name: "Hidratação" },
    //   data: {
    //     imageUrl:
    //       "https://plus.unsplash.com/premium_photo-1682090689948-2c8b24f501b7?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aGFpciUyMHNhbG9vbnxlbnwwfHwwfHx8MA%3D%3D",
    //   },
    // })
